...
>
> Also, we wanted to remind the reviewer that the relative community composition & species richness are the pathways through which intentional release affects community stability (see Theoretical predictions). Our theory predicts that **intentional release changes relative abundance of unenhanced species.** Therefore, although our regression model does not include the effects of relative community composition explicitly, it is the part of the effect of intentional release.
>
