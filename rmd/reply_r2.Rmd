...
This is a revision of "2022-18044 *Intentional release of native species undermines ecological stability.*" Thank you for allowing us to revise our manuscript. We have refined our analysis and text in light of comments from reviewer 3. We hope the manuscript is suitable for publication in PNAS.
...
>
> Our theory predicts that intentional release changes relative abundance of unenhanced species (and some species are competitively excluded as part of this process). The relative community composition & species richness are therefore the pathways through which intentional release affects community stability (see Theoretical predictions). Consequently, the effect of community composition is naturally integrated into the effect of intentional release, statistically speaking.
>
> Please note that, in our causal scenario, the inclusion of community composition in our regression model causes a problem called "over-control bias." (see @arifPredictiveModelsAren2022) The pathway through which intentional release affects community stability is, "intentional release (variable X1)" $\rightarrow$ "community composition (X2)" $\rightarrow$ "community stability (Y)." Statistical theory suggests that including both X1 and X2 to explain Y improperly underestimates (or overlooks) the effect of X1 on Y. Therefore, our model structure is appropriate from the perspective of statistical causal inference.
>
