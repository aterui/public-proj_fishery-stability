...
This is a revision of a manuscript: "2022­18044 *Intentional release of native species undermines ecological stability.*" Thank you for allowing us to revise our manuscript. We have refined our analysis and text in light of comments from the reviewer 3. We hope the manuscript is suitable for publication in PNAS.
...
> We appreciate your recommendation. We believe our unclear writing has caused a confusion -- please let us clarify.
>
> First, the sampling method in the protected watersheds are consistent across all sites and years, so there is no need to include the sampling method as a control factor in the statistical model (clarified in Methods). Further, the sampling method (a combination of cast net and electrofishing) was carefully chosen to catch both water-column and benthic fish species effectively (clarified and mentioned in Discussion; L. 227 --). Therefore, we believe our data are robust to sampling bias.
>
> Second, we appreciate reviewer's comment on irregular sampling interval. In the revised analysis, we have included the number of observation years as an additional covariate to address reviewer's concern. The results were qualitatively similar. Please see also our response to reviewer 3.
>
...
> Some of the watersheds (e.g. Shimonaefutoro) do not receive stocking for the purpose of regional population conservation. The rest of variation across watersheds are due largely to logistical reasons (e.g., accessibility). We have briefly mentioned this in the revised MS (L. 158 --).
...
> Thank you for the important suggestion. We agree that different types of interactions may be important to understand ecosystem-wide impacts of intentional release. We have clarified this point in the revised manuscript. In the meantime, we believe our research is unique and significant in that we have quantified "long-term" impact at the community level. As the reviewer suggested, there are some discussion on the community-level impact of intentional release (very few though). However, none of them evaluated the long-term impact. We have improved the description about the knowledge gap addressed in this study (L51 --)
