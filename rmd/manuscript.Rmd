...
Although captive breeding programs pay close attention to the fate of captive-bred individuals in the wild, it is rare to consider the ecosystem's capacity to support biodiversity. We anticipate that the destabilizing effect of stock enhancement is pervasive across taxa because negative density dependence is a general regulating mechanism of biodiversity. In particular, resource competition may be intensified in the Anthropocene because human influences have caused substantial loss and degradation of natural habitats. Therefore, one important implication of this study is that priorities should be given to the preservation and restoration of natural habitats with a broader focus on biodiversity. For example, recent research underscores the importance of conserving a diverse habitat portfolio that may buffer the impacts of rapid environmental changes. Without a comprehensive framework that appreciates the ecological integrity of self-sustaining communities, stock enhancement will never be effective but impairs biodiversity.
