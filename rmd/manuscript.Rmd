...
Intentional release, however, had little or a stabilizing influence on community dynamics when carrying capacity was sufficiently large ($K=$ `r max(list_param[[2]]$k`); **Figures S4-S6**). In particular, intentional release increased the enhanced species with a low population growth rate ($r_1=$ `r min(list_param[[2]]$r1)`; **Figure S4**). This pattern suggests that intentional release may be effective for species or in environments with limited intraspecific competition (= $r_1 K^{-1}$) and is consistent with the fact that some of the best evidence for successful intentional release comes from re-introduction/translocation programs of extirpated species or population enhancement of long-lived endangered species. In the Sado island (Japan), for example, the endangered Crested Ibis *Nipponia nippon* showed exponential growth of the population since the initial reintroduction of ten captive-bred individuals in 2008. Similarly, translocations of Humpback chub, a federally-listed fish species, seem highly cost-effective in enhancing their tributary populations in the Little Colorado River. It is important to note that there are two common features in these successful examples. First, the receiving ecosystem remains nearly-intact (i.e., high carrying capacity). Second, the number of releases is rather small unlike release programs for commercial and recreational species. These conditions meet the theoretical assumptions with which intentional release led to increased abundance of the enhanced species with negligible impacts on other species. However, the preponderance of unsuccessful reintroduction programs implies that these conditions are not always sufficed. Our analysis suggests that pre-release examination and restoration of environmental capacity may be a key to successful release programs with minimal impacts on other community members.
