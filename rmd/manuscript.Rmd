...
The only scenario where stock enhancement had a little influence on community dynamics was when carrying capacity was sufficiently large ($K=500$; **Figures S7-S12**). In particular, stock enhancement increased, albeit slightly, the average density of the enhanced species with low population growth rate ($r_1=0.5$; **Figures S7 and S8**). This result may explain why some of the best evidence for successful stock enhancement comes from endangered species [@johnsonGeneticRestorationFlorida2010; @oppelPopulationReinforcementDemographic2021], which typically suffer from increased mortality. At the same time, our theoretical analysis illuminates limitation of stock enhancement as a primary tool of ecosystem management. One of the primary motivations for stock enhancement is to mitigate or reverse declining trends of biodiversity due to human impacts, such as habitat loss and fragmentation [@chaseEcosystemDecayExacerbates2020]. However, our results suggest that stock enhancement will not bring desired ecological outcomes unless we restore high levels of environmental capacity to support biodiversity.
