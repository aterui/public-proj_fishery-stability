...
```{r fig-env, fig.width=11, fig.height=8, fig.cap="Distribution of environmental variables in the protected watershed. Note that the number of fish released, ocean productivity (chlorophyll a), and SD elevation are measured at the watershed level while others are measured at the site level."}
