...
for(i in seq_len(nrow(df_param))) {
  ...
  cap[i] <- paste0("Theoretical predictions for the release effect on community dynamics. Rows represent different response variables, and columns show distinct simulation scenarios with different strengths of interspecific competition ($\\bar{\\alpha}$) and relative fitness of captive-bred individuals ($f_R$). Other parameters are: ",
