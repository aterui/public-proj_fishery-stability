...
Parameter values used in the whole community simulation.
...
## Parameter estimates of the Bayesian state-space model
...
for(i in seq_len(nrow(df_param))) {
  ...
  knit_chunk <- paste0("## Figure S", i + j,
                       ...
                       "\n```{r figure_s", i + j,", fig.width = 10, fig.height = 7}
                       \n\n
                       list_g_theory[[",i,"]]
                       \n\n
                       ```\n",
...
## Figure S12 Environmental variables

```{r figure_s12, fig.width=11, fig.height=8}
...
## Figure S13 Correlation plot

```{r figure_s13, fig.width=11, fig.height=11}
