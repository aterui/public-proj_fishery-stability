...
Median estimates of the Bayesian state-space model. See Durante [@duranteNoteMultiplicativeGamma2017] for multiplicative gamma priors. The parameter $\pmb{\phi}$ is a vector of prior scales ($\pmb{\phi}=2.5,...,2.5$). Site-specific parameters were excluded due to a large number of parameters.
