...
**Fish stocking.** The stocking of masu salmon began in the 1950s. Hatchery fish are released in spring (fry [age 0+] and smolt [age 1+] stages) and fall (juvenile stage [age 0+]). Although the fish release occurs at multiple locations within a watershed, the stocking information is available only at the watershed level. We assembled annual records of stock enhancement (the number of fish released) from 1999 to 2019 for each release stage.
...
for(i in 1:length(table_stvy)) {
  ...
  table_legend <- paste0("Sensitivity analysis of the community simulation. Parameter estimates of linear regression models (standard errors in parenthesis) are shown. Response variables are Spearman's correlation between stock enhancement and either temporal mean density ($\\mu$) or SD ($\\sigma$) of ", c_text[i],". Explanatory variables (i.e., simulation parameters) were standardized (mean = 0, SD = 1) before the analysis.")
