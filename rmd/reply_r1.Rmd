...
5.  **Miscellaneous.** We corrected some errors in the previous manuscript (e.g., equation notations). Also, we used more computationally effective codes for GIS work in R. We have updated this part, resulting in very minor changes in environmental variables.
...
> Agreed. We followed your guidance to improve the Introduction and Discussion (**paragraph L186 --, paragraph L210 --**). In short, we have clarified the following point:
>
...
> This greatly helped improve our manuscript, making the results relevant to other systems. We included more information on other salmon and fishery release programs (**paragraph L186 --**).
